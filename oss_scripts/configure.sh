...
curl https://raw.githubusercontent.com/tensorflow/tensorflow/r2.9/.bazelversion -o .bazelversion

# Copy the building configuration of TF.
curl https://raw.githubusercontent.com/tensorflow/tensorflow/r2.9/.bazelrc -o .bazelrc
