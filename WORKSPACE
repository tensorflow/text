...
http_archive(
    ...
    urls = [
        "https://github.com/google/sentencepiece/archive/refs/tags/v0.2.0.zip"
    ],
...
http_archive(
    ...
    sha256 = "b3d6da6d6b62f7e8203010bd23c33fe04f42e8e29850b860353f5b6da30febce",
    strip_prefix = "datasets-4.9.6",
    urls = [
        "https://github.com/tensorflow/datasets/archive/v4.9.6.zip",
    ],
)
