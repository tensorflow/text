...
http_archive(
    ...
    strip_prefix = "tensorflow-2.15.0-rc1",
    sha256 = "97558fe27d872b667b0946a40d8b16204a86c051d41e60d2b87ffb2e2509106c",
    urls = [
        "https://github.com/tensorflow/tensorflow/archive/v2.15.0-rc1.zip"
    ],
)
