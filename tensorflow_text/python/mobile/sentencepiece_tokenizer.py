...
gen_sentencepiece_mobile_tokenizer = load_library.load_op_library(resource_loader.get_path_to_datafile('_sentencepiece_mobile_tokenizer.so'))
    ...
    if ragged_tensor.is_ragged(input_tensor):
      ...
      if input_tensor.shape.ndims > 1:
        ...
        (output_values, row_splits) = (
            gen_sentencepiece_mobile_tokenizer.tf_sentencepiece_tokenize_op(
  ...
  def detokenize(self, input):  # pylint: disable=redefined-builtin
    ...
    if ragged_tensor.is_ragged(input_tensor):
      if input_tensor.flat_values.shape.ndims > 1:
        ...
        return gen_sentencepiece_mobile_tokenizer.tf_sentencepiece_detokenize_op(
