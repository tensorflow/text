...
class WordpieceTokenizer(TokenizerWithOffsets):
  ...
  def __init__(self,
    ...
    Args:
      ...
      max_bytes_per_token: (optional) Max size of subwords, excluding suffix
    ...
    self._max_bytes_per_token = (
        -1 if max_bytes_per_token is None else max_bytes_per_token)
    ...
    with ops.name_scope(
      ...
      values, row_splits, starts, limits = (
          gen_wordpiece_tokenizer.wordpiece_tokenize_with_offsets(
              ...
              max_bytes_per_token=self._max_bytes_per_token,
