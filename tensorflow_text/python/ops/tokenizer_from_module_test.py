...
# encoding=utf-8
"""Tests for tokenizer_from_module."""
...
from tensorflow_text.python.ops import tokenizer_from_module  # pylint: disable=line-too-long
...
class SegmenterTest(parameterized.TestCase,
  ...
  def testTokenize(self,
    ...
    segmenter = tokenizer_from_module.TokenizerFromModule(hub_module_handle)
