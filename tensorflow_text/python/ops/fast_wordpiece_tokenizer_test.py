...
from tensorflow_text.core.pybinds import pywrap_fast_wordpiece_tflite_registrar
  ...
  def testTfliteWordpieceTokenizer(self, end_to_end, text_inputs):
    ...
    interp = interpreter.InterpreterWithCustomOps(
        ...
        custom_op_registerers=[
            pywrap_fast_wordpiece_tflite_registrar.AddFastWordpieceTokenizer
        ])
    ...
    interp = interpreter.InterpreterWithCustomOps(
        model_content=tflite_model,
        custom_op_registerers=[
            pywrap_fast_wordpiece_tflite_registrar.AddFastWordpieceDetokenizer
        ])
    interp.allocate_tensors()
