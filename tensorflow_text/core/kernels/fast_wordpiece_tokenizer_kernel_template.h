...
#if TF_CPLUSPLUS < 201703L

template <tflite::shim::Runtime Rt>
constexpr const char FastWordpieceTokenizeWithOffsetsOp<Rt>::kOpName[];

template <tflite::shim::Runtime Rt>
constexpr const char FastWordpieceTokenizeWithOffsetsOp<Rt>::kDoc[];
...
#if TF_CPLUSPLUS < 201703L
template <tflite::shim::Runtime Rt>
constexpr const char FastWordpieceDetokenizeOp<Rt>::kOpName[];

template <tflite::shim::Runtime Rt>
constexpr const char FastWordpieceDetokenizeOp<Rt>::kDoc[];
#endif
