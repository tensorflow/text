...
using ::tensorflow::constrained_sequence::GreedyAnalysis;
using ::tensorflow::constrained_sequence::ScoreAccessor;
using ::tensorflow::constrained_sequence::ViterbiAnalysis;
