...
<a target="_blank" href="https://github.com/tensorflow/text/tree/master/tensorflow_text/python/ops/sliding_window_op.py">View source</a>
...
* <b>`width`</b>: An integer constant specifying the width of the window. Must be
  greater than zero.

* <b>`axis`</b>: An integer constant specifying the axis along which sliding window
