...
Defined in
[`python/ops/greedy_constrained_sequence_op.py`](https://github.com/tensorflow/text/tree/master/tensorflow_text/python/ops/greedy_constrained_sequence_op.py).
